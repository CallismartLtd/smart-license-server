...
<form class="smlag-form" method="post" id="smlag-reset-password-form">
    ...
    <div class="smlag-form-group">
        ...
        <input type="password" id="smlag-reset-password" name="password_1" class="smlag-input"
        ...
        <div class="smlag-password-strength">
            <div class="smlag-password-strength-bar">
                <div id="smlag-strength-fill" class="smlag-password-strength-fill"></div>
            </div>
            <span id="smlag-strength-text" class="smlag-password-strength-text"></span>
        </div>
    ...
    <div class="smlag-form-group">
        <label for="smlag-reset-password-2" class="smlag-label">
            <i class="ti ti-lock-check" aria-hidden="true"></i>
            Confirm Password
        </label>
        <input type="password" id="smlag-reset-password-2" name="password_2"
            class="smlag-input"
