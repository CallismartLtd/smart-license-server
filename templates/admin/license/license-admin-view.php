...
<?php if ( $license->has_item() ):?>
    <a data-item-id="<?php echo absint( $license->get_item_id() ); ?>" data-license-key="<?php echo esc_attr( $license->get_license_key() ); ?>" data-plugin-name="<?php echo esc_html( $plugin_name ); ?>" class="button action smliser-nav-btn" id="smliserDownloadTokenBtn"><span class="dashicons dashicons-download"></span> Generate Download Token</a>
<?php endif;?>
