...
<?php else : ?>
    ...
    <a href="<?php echo esc_url( add_query_arg( array( 'type' => 'plugin' ), smliser_admin_repo_tab( 'monetization', $app->get_id() ) ) ) ?>" class="button action smliser-nav-btn"><span class="dashicons dashicons-money-alt"></span> Monetization</a>
    <a href="<?php echo esc_url( add_query_arg( array( 'type' => 'plugin' ), smliser_admin_repo_tab( 'edit', $app->get_id() ) ) ) ?>" class="button action smliser-nav-btn"><span class="dashicons dashicons-edit"></span> Edit Plugin</a>
    ...
    <a class="button action smliser-nav-btn smliser-app-delete-button" data-app-info="<?php echo esc_attr( smliser_json_encode_attr( ['slug' => $app->get_slug(), 'type' => $app->get_type()] ) ); ?>"><span class="dashicons dashicons-trash"></span> Delete Plugin</a>
