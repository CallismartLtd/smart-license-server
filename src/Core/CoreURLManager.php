...
/**
 * The core URL manager class.
 */
class CoreURLManager implements URLManagerInterface {
    ...
    */
    ...
    public function client_dashboard_url( string $path = '', array $query = [] ) : URL {
        return $this->url( $this->client_dashboard_url_prefix(), $query )
            ->append_path( $path );
    }
    ...
    */
    ...
    public function uploads_url( string $path  = '' ) : URL {
        return $this->url( $this->uploads_url_prefix() )
            ->append_path( $path );
    }

    /*
    |---------------------------------------------------
    | APPS (assets, downloads, artifacts, repository)
    |---------------------------------------------------
    */
